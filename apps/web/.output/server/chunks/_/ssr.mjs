...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-B3OYdlEj.mjs');
...
!function() {
  try {
    var e = "undefined" != "undefined" ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {}, n = new e.Error().stack;
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "27019755-2e0b-5d99-98ee-b03b00706956");
  } catch (e2) {
  }
}();
hc("");
function generateRpcClient(...args) {
  return hc(...args);
}
const apiClient = generateRpcClient("http://localhost:3001");
...
const $$splitComponentImporter = () => import('./index-CmSQGRsT.mjs');
...
function createRouter() {
  ...
  return routerWithQueryClient(
    createRouter$1({
      ...
      // TODO: Add not found and error components
    }),
    queryClient
  );
}
...
export { serverEntry as default, healthcheckQuery as h };
